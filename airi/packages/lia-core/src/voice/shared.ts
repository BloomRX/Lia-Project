 ...
 *
 * Phase 7.8E note: this id is the only contract point the transitional voice
 * product still shares with a future runnable engine. The engine that lands
 * first (Kokoro) keeps consuming targets shaped exactly like this.
 */
